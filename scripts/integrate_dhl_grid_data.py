...
def load_dhl_grid_data(grid_file: str = "../data/dhl_all_locations.json") -> gpd.GeoDataFrame:
...
def main():
    ...
    grid_file = Path("../data/dhl_all_locations.json")
    if not grid_file.exists():
        print("❌ ERROR: ../data/dhl_all_locations.json not found!")
        print("   Run 'python scripts/dhl_grid_fetch.py' first to fetch complete DHL data.")
        return
