            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div className="border border-gray-200 rounded-lg p-4 hover:border-purple-300 transition">
                  <h4 className="font-semibold text-gray-900 mb-2">Parcel Lockers Research: Last-Mile Delivery Optimization</h4>
                  <p className="text-sm text-gray-700 mb-3">
                    Wetenschappelijk onderzoek naar pakketkluizen en afhaalpunten in de last-mile logistiek.
                    Analyseert locatieplanning, consumentengedrag en duurzaamheidsaspecten van alternatieve
                    bezorgmethoden.
                  </p>
                  <a
